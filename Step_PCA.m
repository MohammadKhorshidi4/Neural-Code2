...
for i = 1:6
    plot(smooth(smooth(cnnew((i-1) * 320 + 1:(i-1) * 320 + 210,4))),smooth(smooth(cnnew((i-1) * 320 + 1:(i-1) * 320 + 210,1))),'--' ...
                ,'LineWidth',1,'Color',col(i,:))
    hold on
    plot(smooth(smooth(cnnew((i-1) * 320 + 211:i * 320,4))),smooth(smooth(cnnew((i-1) * 320 + 211:i * 320,1))),'-' ...
                ,'LineWidth',2,'Color',col(i,:))
    hold on
end
legend('reward = 3 , cue = -1 before reward onset','after reward onset','reward = 3 , cue = 1 before reward onset', ...
    'after reward onset','reward = 6 , cue = -1 before reward onset','after reward onset', ...
    'reward = 6 , cue = 1 before reward onset','after reward onset', ...
    'reward = 9 , cue = -1 before reward onset','after reward onset', ...
    'reward = 9 , cue = 1 before reward onset','after reward onset','Location','southeast', ...
    'Interpreter','latex')
